...
use Inc\Api\Callbacks\CustomFeesCallbacks;
use Inc\Api\Callbacks\AdminCallbacks;

/**
* 
*/
class CustomFeesController extends BaseManager
{
	public $settings;

	public $callbacks;

	public $custom_fees_callbacks;
	...
	{
		if (!$this->activated('custom_fees_manager')) return;

		$this->settings = new SettingsApi();

		$this->callbacks = new AdminCallbacks();

		$this->custom_fees_callbacks = new CustomFeesCallbacks();
	...
	public function setSubpages()
	{
		$this->subpages = array(
			array(
				'parent_slug' => 'woocommerce-custom-features', 
				'page_title' => 'Woocommerce Custom Fees', 
				'menu_title' => 'Custom Fees', 
				'capability' => 'manage_options', 
				'menu_slug' => 'woocommerce-custom-fees', 
				'callback' => array( $this->callbacks, 'adminCustomFees' )
			)
		);
	}
	...
	public function setSettings()
	{
		$args = array(
			array(
				'option_group' => ' woocommerce-custom-features_plugin_custom-feessettings',
				'option_name' => ' woocommerce-custom-features_plugincustom_fees_',
				'callback' => array( $this->custom_feescallbacks, 'cptSanitize' )
			)
		);
	...
	public function setSections()
	{
		$args = array(
			array(
				'id' => ' woocommerce-custom-features_custom-feesindex',
				'title' => 'Custom Post Type Manager',
				'callback' => array( $this->custom_fees_callbacks, 'cptSectionManager' ),
				'page' => ' woocommerce-custom-features_custom_fees'
			)
		);
	...
	public function setFields()
	{
		$args = array(
			array(
				...
				'callback' => array( $this->custom_fees_callbacks, 'textField' ),
				'page' => ' woocommerce-custom-features_custom_fees',
				'section' => ' woocommerce-custom-features_custom_fees_index',
				'args' => array(
					'option_name' => ' woocommerce-custom-features_plugin_custom_fees',
					'label_for' => 'post_type',
			...
			array(
				...
				'title' => 'Singular Name',
				'callback' => array( $this->custom_fees_callbacks, 'textField' ),
				'page' => ' woocommerce-custom-features-custom-fees',
				'section' => ' woocommerce-custom-features_custom_fees_index',
				'args' => array(
					'option_name' => ' woocommerce-custom-features_plugin_custom_fees',
			...
			array(
				...
				'callback' => array( $this->custom_fees_callbacks, 'textField' ),
				'page' => ' woocommerce-custom-features-custom-fees',
				'section' => ' woocommerce-custom-features-custom_fees-index',
				'args' => array(
					'option_name' => ' woocommerce_custom_features_custom_fees',
			...
			array(
				'id' => 'public',
				'title' => 'Public',
				'callback' => array( $this->custom_fees_callbacks, 'checkboxField' ),
				'page' => ' woocommerce-custom-features_custom_fees',
				'section' => ' woocommerce-custom-features_custom_fees_index',
				'args' => array(
					'option_name' => ' woocommerce-custom-features_plugin_custom_fees',
	...
	{
		$options = get_option( ' woocommerce-custom-features_plugin_custom-fees' ) ?: array();
